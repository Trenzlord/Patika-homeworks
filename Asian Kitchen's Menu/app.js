...
function listKoreaFoods() {
  ...
  menu.map((item) => {
    if (item.category === "Korea") {
      koreaFood += createFoods(item);
    }
  });

  menuContainer.innerHTML = koreaFood;
};
...
function listJapanFoods() {
  ...
  menuContainer.innerHTML = japanFood;
};
...
function listChinaFoods() {
  ...
  menu.map((item) => {
    if (item.category === "China") {
      chinaFood += createFoods(item);
    }
  });

  menuContainer.innerHTML = chinaFood;
};
